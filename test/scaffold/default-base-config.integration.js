...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    bitcored.spawn.datadir.should.equal(home + '/.btx');
    bitcored.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/bitcored'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.bitcored.spawn.datadir.should.equal('./data2');
  });
});
