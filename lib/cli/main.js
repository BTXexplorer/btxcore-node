...
var btxcorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = btxcorenode.version;
  var create = btxcorenode.scaffold.create;
  var add = btxcorenode.scaffold.add;
  var start = btxcorenode.scaffold.start;
  var remove = btxcorenode.scaffold.remove;
  var callMethod = btxcorenode.scaffold.callMethod;
  var findConfig = btxcorenode.scaffold.findConfig;
  var defaultConfig = btxcorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the bitcore database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `btxcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ btxcore-node add wallet-service');
      console.log('    $ btxcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ btxcore-node remove wallet-service');
      console.log('    $ btxcore-node remove insight-api');
      console.log();
    });
