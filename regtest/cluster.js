...
describe('bitcore Cluster', function() {
  var node;
  var daemons = [];
  ...
  var nodesConf = [
    {
      ...
      conf: path.resolve(__dirname, './data/node1/btx.conf'),
      rpcuser: 'bitcore',
    ...
    },
    {
      ...
      conf: path.resolve(__dirname, './data/node2/btx.conf'),
      rpcuser: 'bitcore',
      rpcpassword: 'local321',
      rpcport: 30522,
    ...
    },
    {
      ...
      conf: path.resolve(__dirname, './data/node3/btx.conf'),
      rpcuser: 'bitcore',
      rpcpassword: 'local321',
      rpcport: 30523,
  ...
  before(function(done) {
    log.info('Starting 3 bitcored daemons');
    this.timeout(60000);
  ...
  it('step 1: will connect to three bitcored daemons', function(done) {
    this.timeout(20000);
    var configuration = {
      network: 'regtest',
      services: [
    ...
    var regtest = btxcore.Networks.get('regtest');
  ...
  it('step 2: receive block events', function(done) {
    this.timeout(10000);
    node.services.bitcored.once('tip', function(height) {
