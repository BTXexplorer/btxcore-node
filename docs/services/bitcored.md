...
If "queryMempool" is set as true (it is true by default), it will show unconfirmed transactions from the bitcore mempool. However, if you specify "start" and "end", "queryMempool" is ignored and is always false.
